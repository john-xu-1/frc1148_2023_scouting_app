...
class _log_in extends State<log_in> {
  ...
  //the spreadsheet is to keep track of my code results here
  
  // There is a list of names
      // Avery, Alex Lee, Sophia, Kevin, Alex Segor, CJ, Mattin, Dylan, Alex Segor, joseph
  // There is a list of matchlists
      // Q:1, Q:2, Q:3, ect.
      // list of teams in match
           // ['frc3863', 'frc3128B', 'frc4415'], ['frc1148B', 'frc696B', 'frc9282']
  
  // be able to return a team number and color (name, Q:)
  final _creds = r'''
  {
