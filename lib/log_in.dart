...
class _log_in extends State<log_in> {
  ...
  //   try {
     // for (String entry in entries) {
        ...
        //   final name = extractName(entries); // Replace with your method of extracting the name
        //   final qmNumber = extractQmNumber(entries); // Replace with your method of extracting the qm number
